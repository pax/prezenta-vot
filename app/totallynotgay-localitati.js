  ...
  function layerStyle(feature) {
    ...
    switch (selectedVar) {
      case 'prezenta':
        ...
        break;
      // case 'muchextra':
      //   value = feature.props.total[selectedLayer]['LT'] - feature.props.total[selectedLayer]['LP'] - feature.props.total[selectedLayer]['LS'] - feature.props.total[selectedLayer]['UM'] + 0;
      //   max = 50;
      //   break;
      case 'dead':
        value = feature.props.total[selectedLayer]['LT'] == 0 ? 5 : 0;
        max = 50;
        break;
      case 'lista':
        ...
        break;
      case 'ghost':
        value = (feature.props.total[selectedLayer]['LT'] <= 5) && (feature.props.total[selectedLayer]['LT'] >= 0) ? 10 : 0;
        max = 50;
        break;
      case 'LP':
        value = feature.props.total[selectedLayer][selectedVar]/3;
        max = 1527;
        break;
      case 'LS':
        value = feature.props.total[selectedLayer][selectedVar];
        max = 8654;
        break;
      case 'UM':
        value = feature.props.total[selectedLayer][selectedVar];
    ...
    // radius=Math.round(feature.props.total[selectedLayer][selectedVar]/10,0);
    //  0 → 0
    //  max → 50
  ...
  geojsonLayer.on("layeradd", function(e) {
    var marker = e.layer,
      feature = marker.feature;
        ...
        var out = "<header> ";
                out += "" + feature.props.localitate + " – " + feature.props.jud + "<br/><b>" +  feature.props.sectii + "</b> secții, <b>" + feature.props.pe_lista + "</b> alegători pe liste.</header>";
        // out += JSON.stringify(feature.props.ts, null, 2)
        out += locationProfie(feature.props.total,feature.props.pe_lista);
