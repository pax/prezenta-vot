...
$PASSWORD = 'eur0pam adm1n';  // Set the password, to access the file manager... (optional)
...
if ($PASSWORD) {
    ...
    if (!$_SESSION['_sfm_allowed']) {
      // sha1, and random bytes to thwart timing attacks.  Not meant as secure hashing.
        ...
        echo '<html><body><center><form style="border: 1px solid #CCC; box-shadow: 4px 4px 0 rgba(0,0,0,.25); padding: 1em; margin: 2em; background-color: LightYellow; display: inline-block; " action=? method=post>PASSWORD:<input  type=password name=p /></form></center></body></html>';
        exit;
    }
}
...
<?php endif; ?>
  ...
  <mark style="border: 1px solid #CCC; padding: .5em; box-shadow: 4px 4px 0 rgba(0,0,0,.25);"><a href="../../app/generator/">&laquo; admin</a> | <a href="../../">front</a> </mark>
<div id="top">
    <?php if ($allow_upload == true) : ?>
